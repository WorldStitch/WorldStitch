...
def upgrade() -> None:
    with op.batch_alter_table("notes") as batch_op:
        ...
        batch_op.add_column(sa.Column("folder", sa.String(200), nullable=True, server_default=""))

    with op.batch_alter_table("users") as batch_op:
        batch_op.add_column(sa.Column("email", sa.String(200), nullable=True, server_default=""))
