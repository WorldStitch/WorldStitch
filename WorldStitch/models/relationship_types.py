"""
Predefined relationship type registry for WorldStitch.
...
RELATIONSHIP_TYPES: list[dict] = [
    ...
    {"type": "hunted", "category": "Conflict", "inverse": "is hunted by", "default_direction": "unidirectional"},
    {
        "type": "sacrificed for",
        "category": "Conflict",
        "inverse": "received sacrifice from",
        "default_direction": "unidirectional",
    },
    ...
    },
    {
        "type": "serves",
        "category": "Power & Hierarchy",
        "inverse": "is served by",
        "default_direction": "unidirectional",
    },
    {
        "type": "employs",
        "category": "Power & Hierarchy",
        "inverse": "is employed by",
        "default_direction": "unidirectional",
    },
    {
        "type": "rules over",
    ...
    },
    {
        "type": "overthrew",
        "category": "Power & Hierarchy",
        "inverse": "was overthrown by",
        "default_direction": "unidirectional",
    },
    {
        "type": "succeeded",
        "category": "Power & Hierarchy",
        "inverse": "was succeeded by",
        "default_direction": "unidirectional",
    },
    {
        "type": "founded",
        "category": "Power & Hierarchy",
        "inverse": "was founded by",
        "default_direction": "unidirectional",
    },
    {
        "type": "member of",
    ...
    {
        "type": "knows about",
        "category": "Knowledge & Secrets",
        "inverse": "is known about by",
        "default_direction": "unidirectional",
    },
    {
        "type": "witnessed",
        "category": "Knowledge & Secrets",
        "inverse": "was witnessed by",
        "default_direction": "unidirectional",
    },
    {
        "type": "is deceiving",
        "category": "Knowledge & Secrets",
        "inverse": "is being deceived by",
        "default_direction": "unidirectional",
    },
    {
        "type": "was deceived by",
        "category": "Knowledge & Secrets",
        "inverse": "deceived",
        "default_direction": "unidirectional",
    },
    {
        "type": "is blackmailing",
        "category": "Knowledge & Secrets",
        "inverse": "is being blackmailed by",
        "default_direction": "unidirectional",
    },
    {
        "type": "shares a secret with",
        "category": "Knowledge & Secrets",
        "inverse": None,
    ...
    },
    {
        "type": "unaware of",
        "category": "Knowledge & Secrets",
        "inverse": "is unknown to",
        "default_direction": "unidirectional",
    },
    # ── Creation & Origin ─────────────────────────────────────────────────────
    {
        "type": "created",
        "category": "Creation & Origin",
    ...
    },
    {
        "type": "destroyed",
        "category": "Creation & Origin",
        "inverse": "was destroyed by",
        "default_direction": "unidirectional",
    },
    {
        "type": "discovered",
        "category": "Creation & Origin",
        "inverse": "was discovered by",
        "default_direction": "unidirectional",
    },
    {
        "type": "forged",
        "category": "Creation & Origin",
        "inverse": "was forged by",
        "default_direction": "unidirectional",
    },
    {
        "type": "summoned",
        "category": "Creation & Origin",
        "inverse": "was summoned by",
        "default_direction": "unidirectional",
    },
    {
        "type": "cursed",
        "category": "Creation & Origin",
        "inverse": "was cursed by",
        "default_direction": "unidirectional",
    },
    {
        "type": "blessed",
        "category": "Creation & Origin",
        "inverse": "was blessed by",
        "default_direction": "unidirectional",
    },
    {
        "type": "enchanted",
        "category": "Creation & Origin",
        "inverse": "was enchanted by",
        "default_direction": "unidirectional",
    },
    {
        "type": "corrupted",
        "category": "Creation & Origin",
        "inverse": "was corrupted by",
        "default_direction": "unidirectional",
    },
    # ── Location ──────────────────────────────────────────────────────────────
    ...
    {"type": "haunts", "category": "Location", "inverse": "is haunted by", "default_direction": "unidirectional"},
    {
        "type": "was born in",
        "category": "Location",
        "inverse": "is birthplace of",
        "default_direction": "unidirectional",
    },
    {
        "type": "died in",
        "category": "Location",
        "inverse": "is death location of",
        "default_direction": "unidirectional",
    },
    ...
    {
        "type": "previously owned by",
        "category": "Item",
        "inverse": "previously owned",
        "default_direction": "unidirectional",
    },
    ...
    {
        "type": "worships",
        "category": "Belief & Ideology",
        "inverse": "is worshipped by",
        "default_direction": "unidirectional",
    },
    {
        "type": "rejects",
        "category": "Belief & Ideology",
        "inverse": "is rejected by",
        "default_direction": "unidirectional",
    },
    {
        "type": "belongs to cult of",
        "category": "Belief & Ideology",
        "inverse": "has cult member",
        "default_direction": "unidirectional",
    },
    {
        "type": "heretic of",
    ...
    },
    {
        "type": "tributary of",
        "category": "Faction & Organization",
        "inverse": "receives tribute from",
        "default_direction": "unidirectional",
    },
    {
        "type": "sponsors",
        "category": "Faction & Organization",
        "inverse": "is sponsored by",
        "default_direction": "unidirectional",
    },
    {
        "type": "opposes",
        "category": "Faction & Organization",
        "inverse": "is opposed by",
        "default_direction": "unidirectional",
    },
    {
        "type": "allied with",
    ...
    {"type": "preceded", "category": "Event & Lore", "inverse": "followed", "default_direction": "unidirectional"},
    {
        "type": "commemorates",
        "category": "Event & Lore",
        "inverse": "is commemorated by",
        "default_direction": "unidirectional",
    },
    {
        "type": "was covered up by",
        "category": "Event & Lore",
        "inverse": "covered up",
        "default_direction": "unidirectional",
    },
    {
        "type": "prophesied",
        "category": "Event & Lore",
        "inverse": "is prophesied by",
        "default_direction": "unidirectional",
    },
    # ── Narrative & Meta ──────────────────────────────────────────────────────
    {
        "type": "foreshadows",
        "category": "Narrative & Meta",
        "inverse": "is foreshadowed by",
        "default_direction": "unidirectional",
    },
    ...
    {
        "type": "marks the site of",
        "category": "Narrative & Meta",
        "inverse": "site marked by",
        "default_direction": "unidirectional",
    },
]
